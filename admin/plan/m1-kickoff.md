...
updated: 2025-09-22 15:05 UTC / 2025-09-23 00:05 KST
status: ready
tags: [plan, mvp, web, api, ci]
schemaVersion: 1
description: 베이스 세팅 이후 실제 앱/서버/CI 골조를 세우기 위한 실행 계획과 수용 기준, 새 채팅 트리거 문구를 정의
code_refs: ["scripts/validate_docs.sh", "scripts/validate_refs.sh", "scripts/validate_migrations.sh", "scripts/validate_code_headers.sh", "scripts/validate_sidecar_meta.sh"]
---
